...
|------|--------|--------------------------|
| `script-passangers.gs` | CRM Пасажири | `1U1deQJvMPZ9fctIEoHCXr8cFQmgWLVe2VRhlzb5IpjI` |
| `script-cargo.gs` | CRM Посилки | `1RyWJ-ZQ-OQbeD65fZXR-WEwP_kwuNllikiA3Q1rjtlo` |
...
### Пасажири (CRM)
```
API_URL = AKfycbxXVqoG5NZrSXOYx1uj3IYup5GhotV95Y-DwavSi6WJoxtfXq4WbYPzQBuMm2QUXkkV
