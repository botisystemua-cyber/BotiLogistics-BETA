...
// ============================================
var ACTION_LABELS = {
  'savePackage': 'Збереження посилки',
  'archivePackage': 'Архівація',
  'deletePackage': 'Видалення назавжди',
  'bulkArchive': 'Масовий архів',
  'bulkRestore': 'Масове відновлення',
  'bulkDeleteForever': 'Масове видалення назавжди',
  'bulkRefuse': 'Масова відмова',
  'copyToRoute': 'Копіювання в маршрут',
  'bulkAssignVehicle': 'Масове призначення авто',
  'assignVehicle': 'Призначення авто',
  'deleteFromRoute': 'Видалення з маршруту',
  'bulkDeleteFromRoute': 'Масове видалення з маршруту',
  'bulkSetDriverStatus': 'Масова зміна статусу водія',
  'restoreToOriginal': 'Відновлення до оригіналу',
  'savePassenger': 'Збереження пасажира',
  'updatePassenger': 'Оновлення пасажира',
  'archivePassenger': 'Архівація пасажира',
  'restorePassenger': 'Відновлення пасажира',
  'deletePassenger': 'Видалення пасажира',
  'bulkTransfer': 'Масова пересадка',
  'bulkRemoveVehicle': 'Масове зняття авто',
  'applyStatus': 'Зміна статусу',
  'moveDirection': 'Зміна напрямку',
  'loginSuccess': 'Вхід в систему',
  ...
  'openRoute': 'Відкриття маршруту',
  'driverSetStatus': 'Водій: зміна статусу',
  'driverCancel': 'Водій: скасування',
  'driverUndoStatus': 'Водій: відміна статусу',
  'driverSetPassengerStatus': 'Водій: статус пасажира',
  'driverAddLead': 'Водій: новий лід',
  'driverEditDelivery': 'Водій: редагування'
};

function logActionFromClient(data) {
  var actionKey = data.logAction || 'unknown';
